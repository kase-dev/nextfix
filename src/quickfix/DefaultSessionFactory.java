...
public class DefaultSessionFactory implements SessionFactory {
    ...
    private static final Map<String, DataDictionary> dictionaryCache =  new ConcurrentHashMap<String, DataDictionary>();
                                                          //            new Hashtable<String, DataDictionary>();
    ...
    public DefaultSessionFactory(Application application, MessageStoreFactory messageStoreFactory,
        ...
        this.messageFactory = new KaseFixMessageFactory();
    }
    ...
    public Session create(SessionID sessionID, SessionSettings settings) throws ConfigError {
        try {
            ...
            ApplVerID senderDefaultApplVerID = null;
            ...
            if (sessionID.isFIXT()) {
                ...
                String defAppVerIdStr = settings.getString(sessionID, Session.SETTING_DEFAULT_APPL_VER_ID);
                senderDefaultApplVerID = toApplVerID(defAppVerIdStr);
    ...
    private ApplVerID toApplVerID(String value) {
        if (isApplVerIdEnum(value)) {
            return ApplVerID.getByValue(value);
        } else {
