...
public class FIXProtocolCodecFactory extends DemuxingProtocolCodecFactory {
    ...
    public FIXProtocolCodecFactory() {
        ...
        super.addMessageDecoder(FIXMessageDecoder.class);
        super.addMessageEncoder(Message.class, new FIXMessageEncoder());
        super.addMessageEncoder(String.class, new FIXStringEncoder());
    }
}
