 ...
 */
public class FIXStringEncoder implements MessageEncoder<String> {

    private final String charsetEncoding;


    public FIXStringEncoder() {
        charsetEncoding = CharsetSupport.getCharset();
    }


    public void encode(IoSession session, String fixMessageString, ProtocolEncoderOutput out)
