...
public class CachedFileStore implements MessageStore {
    ...
    /*
     * (non-Javadoc)
     * @see quickfix.store.MessageStore#getCreationTime()
     */
    ...
    /*
     * (non-Javadoc)
     * @see quickfix.store.MessageStore#getNextSenderMsgSeqNum()
     */
    ...
    /*
     * (non-Javadoc)
     * @see quickfix.store.MessageStore#getNextTargetMsgSeqNum()
     */
    ...
    /*
     * (non-Javadoc)
     * @see quickfix.store.MessageStore#setNextSenderMsgSeqNum(int)
     */
    ...
    /*
     * (non-Javadoc)
     * @see quickfix.store.MessageStore#setNextTargetMsgSeqNum(int)
     */
    ...
    /*
     * (non-Javadoc)
     * @see quickfix.store.MessageStore#incrNextSenderMsgSeqNum()
     */
    ...
    /*
     * (non-Javadoc)
     * @see quickfix.store.MessageStore#incrNextTargetMsgSeqNum()
     */
    ...
    /*
     * (non-Javadoc)
     * @see quickfix.store.MessageStore#get(int, int, java.util.Collection)
     */
    ...
    /*
     * (non-Javadoc)
     * @see quickfix.store.MessageStore#set(int, java.lang.String)
     */
    ...
    /*
     * (non-Javadoc)
     * @see quickfix.store.MessageStore#reset()
     */
                ...
                try {
                    ...
                    while (headerDataInputStream.available() > 0) {
                        ...
                        if (sequenceNumber >= startSequence && sequenceNumber <= endSequence) {
                            indexPerSequenceNumber.put(sequenceNumber, new long[] { offset,
                                    size });
                        }
                    }
                } catch (final IOException e) {
