...
import kz.kase.fix.BusinessRejectReason;
import static kz.kase.fix.BusinessRejectReason.*;

public class BusinessRejectReasonText  {
    private static HashMap<BusinessRejectReason, String> rejectReasonText = new HashMap<BusinessRejectReason, String>();
