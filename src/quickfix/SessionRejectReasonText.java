...
import static kz.kase.fix.SessionRejectReason.*;

class SessionRejectReasonText  {
    private static HashMap<SessionRejectReason, String> rejectReasonText = new HashMap<SessionRejectReason, String>();
    ...
    public static String getMessage(SessionRejectReason sessionRejectReason) {
